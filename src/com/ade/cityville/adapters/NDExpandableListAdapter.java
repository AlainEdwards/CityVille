...
public class NDExpandableListAdapter extends BaseExpandableListAdapter{
    ...
    public NDExpandableListAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.list_group_home_item, null);
        }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.list_group_home, null);
        }
